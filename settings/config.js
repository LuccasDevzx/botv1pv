module.exports = {
  ...
  embed: {
    ...
    footertext: "Tropa Do Canada | Music ",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  // others
  guildID: process.env.guildID || "1017245389088374804", // for slash command
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1030806523758252055&permissions=8&scope=bot%20applications.commands`,
